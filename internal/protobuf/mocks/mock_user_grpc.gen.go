...
// Source: internal/protobuf/user_grpc.pb.go
//
...
func (m *MockUserServiceClient) Login(ctx context.Context, in *protobuf.LoginRequest, opts ...grpc.CallOption) (*protobuf.AuthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*protobuf.AuthResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) Register(ctx context.Context, in *protobuf.RegisterRequest, opts ...grpc.CallOption) (*protobuf.AuthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// Login mocks base method.
func (m *MockUserServiceServer) Login(arg0 context.Context, arg1 *protobuf.LoginRequest) (*protobuf.AuthResponse, error) {
	m.ctrl.T.Helper()
...
// Register mocks base method.
func (m *MockUserServiceServer) Register(arg0 context.Context, arg1 *protobuf.RegisterRequest) (*protobuf.AuthResponse, error) {
	m.ctrl.T.Helper()
